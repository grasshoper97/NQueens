...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/java_v1.5_jni
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/java_v1.5_jni/Main.java
argglobal
silent! argdel *
argadd Main.java
edit ~/test/NQueen/CheckOne_Datafile_compare/java_v1.5_jni/Main.java
...
64
normal! zo
let s:l = 73 - ((16 * winheight(0) + 15) / 30)
...
argglobal
enew
file ~/test/NQueen/CheckOne_Datafile_compare/java_v1.5_jni/__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
