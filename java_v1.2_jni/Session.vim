...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/java_v1.2_jni
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +72 ~/test/NQueen/CheckOne_Datafile_compare/java_v1.2_jni/check.cpp
argglobal
silent! argdel *
argadd check.cpp
edit ~/test/NQueen/CheckOne_Datafile_compare/java_v1.2_jni/check.cpp
...
let s:l = 72 - ((14 * winheight(0) + 15) / 30)
