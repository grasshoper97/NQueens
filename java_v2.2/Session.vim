...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/java_v2.2
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/java_v2.2/Caculator.java
argglobal
silent! argdel *
argadd Caculator.java
edit ~/test/NQueen/CheckOne_Datafile_compare/java_v2.2/Caculator.java
...
89
normal! zo
let s:l = 55 - ((2 * winheight(0) + 15) / 30)
...
argglobal
enew
file ~/test/NQueen/CheckOne_Datafile_compare/java_v2.2/__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
