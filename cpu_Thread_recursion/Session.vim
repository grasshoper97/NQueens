...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/cpu_Thread_recursion_test
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/cpu_Thread_recursion_test/check.cpp
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/cpu_Thread_recursion/check.cpp
argglobal
silent! argdel *
argadd check.cpp
set stal=2
edit ~/test/NQueen/CheckOne_Datafile_compare/cpu_Thread_recursion_test/check.cpp
...
exe 'vert 1resize ' . ((&columns * 102 + 71) / 143)
exe 'vert 2resize ' . ((&columns * 40 + 71) / 143)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
argglobal
enew
file ~/test/NQueen/CheckOne_Datafile_compare/cpu_Thread_recursion_test/__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
...
exe 'vert 1resize ' . ((&columns * 102 + 71) / 143)
exe 'vert 2resize ' . ((&columns * 40 + 71) / 143)
tabedit ~/test/NQueen/CheckOne_Datafile_compare/cpu_Thread_recursion/check.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
23
normal! zo
let s:l = 25 - ((22 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
normal! 026|
lcd ~/test/NQueen/CheckOne_Datafile_compare/cpu_Thread_recursion_test
tabnext 2
set stal=1
if exists('s:wipebuf')
