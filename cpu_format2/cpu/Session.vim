...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/cpu_format2/cpu
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/cpu_format2/cpu/run100_900.sh
argglobal
silent! argdel *
argadd run100_900.sh
edit ~/test/NQueen/CheckOne_Datafile_compare/cpu_format2/cpu/run100_900.sh
