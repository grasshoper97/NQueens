...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/cpu_format2
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/cpu_format2/check.cpp
argglobal
silent! argdel *
argadd check.cpp
edit ~/test/NQueen/CheckOne_Datafile_compare/cpu_format2/check.cpp
