...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/cpu_TBB_file
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +140 ~/test/NQueen/CheckOne_Datafile_compare/cpu_TBB_file/a.cpp
argglobal
silent! argdel *
argadd a.cpp
edit ~/test/NQueen/CheckOne_Datafile_compare/cpu_TBB_file/a.cpp
...
46
normal! zo
let s:l = 140 - ((12 * winheight(0) + 14) / 28)
