...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/cpu_mthread_tbb
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +153 ~/test/NQueen/CheckOne_Datafile_compare/cpu_mthread_tbb/check.cpp
argglobal
silent! argdel *
argadd check.cpp
edit ~/test/NQueen/CheckOne_Datafile_compare/cpu_mthread_tbb/check.cpp
