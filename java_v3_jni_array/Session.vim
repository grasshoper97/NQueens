...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/java_v3_jni
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/java_v3_jni/check.cpp
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/java_v3_jni/m_JVM.cpp
argglobal
silent! argdel *
argadd check.cpp
edit ~/test/NQueen/CheckOne_Datafile_compare/java_v3_jni/check.cpp
...
exe 'vert 1resize ' . ((&columns * 116 + 78) / 157)
exe 'vert 2resize ' . ((&columns * 40 + 78) / 157)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
23
normal! zo
let s:l = 41 - ((12 * winheight(0) + 15) / 30)
...
argglobal
enew
file ~/test/NQueen/CheckOne_Datafile_compare/java_v3_jni/__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
