...
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/java_v1.4.1_jni/check.cpp
argglobal
silent! argdel *
argadd java_v1.4.1_jni
edit ~/test/NQueen/CheckOne_Datafile_compare/java_v1.4.1_jni/check.cpp
...
let s:l = 58 - ((29 * winheight(0) + 15) / 30)
