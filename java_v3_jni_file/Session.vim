...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/java_v3_jni_file
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/java_v3_jni_file/40w_100w.txt
argglobal
silent! argdel *
argadd 40w_100w.txt
edit ~/test/NQueen/CheckOne_Datafile_compare/java_v3_jni_file/40w_100w.txt
