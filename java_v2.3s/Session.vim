...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/java_v2.3s
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/java_v2.3s/Caculator.java
argglobal
silent! argdel *
argadd Caculator.java
edit ~/test/NQueen/CheckOne_Datafile_compare/java_v2.3s/Caculator.java
...
40
normal! zo
let s:l = 63 - ((12 * winheight(0) + 15) / 30)
...
argglobal
enew
file ~/test/NQueen/CheckOne_Datafile_compare/java_v2.3s/__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
