...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/java_v1.3_jni
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +41 ~/test/NQueen/CheckOne_Datafile_compare/java_v1.3_jni/m_JVM.cpp
argglobal
silent! argdel *
argadd m_JVM.cpp
edit ~/test/NQueen/CheckOne_Datafile_compare/java_v1.3_jni/m_JVM.cpp
