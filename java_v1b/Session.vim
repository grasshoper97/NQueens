...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/java_v1b
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/java_v1b/CountTask.java
argglobal
silent! argdel *
argadd CountTask.java
edit ~/test/NQueen/CheckOne_Datafile_compare/java_v1b/CountTask.java
...
86
normal! zo
let s:l = 116 - ((22 * winheight(0) + 15) / 30)
...
argglobal
enew
file ~/test/NQueen/CheckOne_Datafile_compare/java_v1b/__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
