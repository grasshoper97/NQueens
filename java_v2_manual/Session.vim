...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/java_v2_manual
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/java_v2_manual/run.sh
argglobal
silent! argdel *
argadd run.sh
edit ~/test/NQueen/CheckOne_Datafile_compare/java_v2_manual/run.sh
...
argglobal
enew
file ~/test/NQueen/CheckOne_Datafile_compare/java_v2_manual/__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
