...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/cpu_Thread/1_60
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/cpu_Thread/1_60/getall_print.sh
argglobal
silent! argdel *
argadd getall_print.sh
edit ~/test/NQueen/CheckOne_Datafile_compare/cpu_Thread/1_60/getall_print.sh
...
let s:l = 33 - ((27 * winheight(0) + 14) / 28)
...
argglobal
enew
file ~/test/NQueen/CheckOne_Datafile_compare/cpu_Thread/1_60/__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
