...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/java_v1
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +83 ~/test/NQueen/CheckOne_Datafile_compare/java_v1/CountTask.java
argglobal
silent! argdel *
argadd CountTask.java
edit ~/test/NQueen/CheckOne_Datafile_compare/java_v1/CountTask.java
...
let s:l = 83 - ((14 * winheight(0) + 15) / 30)
