...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/cpu_TBB_arr
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +61 ~/test/NQueen/CheckOne_Datafile_compare/cpu_TBB_arr/a.cpp
argglobal
silent! argdel *
argadd a.cpp
edit ~/test/NQueen/CheckOne_Datafile_compare/cpu_TBB_arr/a.cpp
