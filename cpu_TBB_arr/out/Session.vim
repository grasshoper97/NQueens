...
silent only
cd ~/test/NQueen/CheckOne_Datafile_compare/cpu_TBB/out
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/test/NQueen/CheckOne_Datafile_compare/cpu_TBB/out/all.txt
argglobal
silent! argdel *
argadd all.txt
edit ~/test/NQueen/CheckOne_Datafile_compare/cpu_TBB/out/all.txt
...
let s:l = 35 - ((22 * winheight(0) + 11) / 23)
